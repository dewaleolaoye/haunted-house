...
// Grave
// static/grave/plastered_stone_wall_1k
...
roof.position.y = houseMeasurements.height + 0.75; // 0.75 is the half of the height of the cone height
 ...
 */
// Ambient light
const ambientLight = new THREE.AmbientLight('#86cdff', 0.2755);
 ...
 * Fog
 */
// scene.fog = new THREE.Fog('#efefef', 10, 13);
